::AvatarMod.Const <- {
	...
	TotalPoints = 40,
	TotalTalents = 9,
	BackgroundChoice = "ALT", // "ONE", "ALT", "ALL"
...
::AvatarMod.Const.ScenarioBackgrounds["scenario.deserters"] <- {
	...
	AlternativeBackgrounds = ["militia_background", "farmhand_background", "daytaler_background", "fisherman_background"]
};
::AvatarMod.Const.ScenarioBackgrounds["scenario.early_access"] <- {
	...
	AlternativeBackgrounds = ["hedge_knight_background", "retired_soldier_background"]
};
::AvatarMod.Const.ScenarioBackgrounds["scenario.gladiators"] <- {
	...
	AlternativeBackgrounds = ["swordmaster_background"]
};
::AvatarMod.Const.ScenarioBackgrounds["scenario.lone_wolf"] <- {
	...
	StartingLevel = 4,
	AlternativeBackgrounds = ["swordmaster_background", "adventurous_noble_background", "disowned_noble_background", "bastard_background"]
};
...
::AvatarMod.Const.ScenarioBackgrounds["scenario.militia"] <- {
	...
	AlternativeBackgrounds = ["retired_soldier_background"]
};
...
::AvatarMod.Const.ScenarioBackgrounds["scenario.rangers"] <- {
	...
	AlternativeBackgrounds = ["hunter_background", "beast_hunter_background"]
};
...
::AvatarMod.Const.ScenarioBackgrounds["scenario.trader"] <- {
	...
	AlternativeBackgrounds = ["caravan_hand_background"]
};
::AvatarMod.Const.ScenarioBackgrounds["scenario.tutorial"] <- {
	...
	AlternativeBackgrounds = ["hedge_knight_background", "retired_soldier_background", "swordmaster_background"]
};
